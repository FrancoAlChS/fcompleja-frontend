...
export class RegistrarMarcadorComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<RegistrarMarcadorComponent>,
  ...
  ngOnInit() {
    this.titulo = "REGISTRAR MARCADOR";
    ...
    this.marcadorForm = new FormGroup({
      ...
      tipoMarcador: new FormControl(null, [Validators.required]),
      marcador: new FormControl(null, [Validators.required]),
      periodicidadMinima: new FormControl(null, [Validators.required]),
      periodicidadMaxima: new FormControl(null, [Validators.required]),
        ...
        this.marcadorService.registrarMarcador(this.marcadorRequest).subscribe(
          (respuesta: WsResponse) => {
            ...
            if (respuesta.audiResponse.codigoRespuesta != "0") {
              console.error("Error al Registrar Marcador");
              this.openDialogMensaje(
                MENSAJES.ERROR_SERVICIO,
                "Error al Registrar Marcador",
                true,
                false,
                null
              );
