...
@Component({
  selector: "app-registrar-criterio",
  templateUrl: "./registrar.component.html",
})
export class RegistrarCriterioComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<RegistrarCriterioComponent>,
  ...
  ngOnInit() {
    ...
    this.titulo = "REGISTRAR CRITERIO";
  ...
  accionMarcador() {
    ...
    this.marcadorRequest.codCriterioLargo = this.marcadorForm
      .get("codigo")
      .value.toString()
      .padStart(2, "0");
