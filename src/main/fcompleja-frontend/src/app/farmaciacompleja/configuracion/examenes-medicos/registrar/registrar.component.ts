...
export class RegistrarExamenMedicoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<RegistrarExamenMedicoComponent>,
  ...
  ngOnInit() {
    ...
    this.titulo = "AGREGAR EXÁMEN MÉDICO";
    ...
    this.marcadorForm = new FormGroup({
      ...
      tipoIngreso: new FormControl(null, [Validators.required]),
      unidadMedida: new FormControl(null, []),
      rangoMin: new FormControl(null, []),
      rangoMax: new FormControl(null, []),
  ...
  accionMarcador() {
    ...
    if (this.marcadorForm.invalid) {
      ...
      this.marcadorRequest.usuarioCrea = String(
